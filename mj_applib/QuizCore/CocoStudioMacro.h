...
#define EVENT_MAP(class_name, func_name) \
{#func_name, CC_CALLBACK_2(class_name::func_name, this)}

#define REGISTER_READER(class_name) \
CSLoader::getInstance()->registReaderObject(#class_name, (ObjectFactory::Instance)class_name::getInstance)
