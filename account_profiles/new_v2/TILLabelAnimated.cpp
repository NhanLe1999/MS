...
TILLabelBMFontAnimated* TILLabelBMFontAnimated::createWithBMFont(const std::string& bmfontFilePath, const std::string& text, const cocos2d::TextHAlignment& alignment /* = TextHAlignment::LEFT */, int maxLineWidth /* = 0 */, const cocos2d::Vec2& imageOffset /* = Vec2::ZERO */)
{
	auto ret = new TILLabelBMFontAnimated();
...
TILLabelBMFontAnimated* TILLabelBMFontAnimated::createWithTTF(const std::string& text, const std::string& fontFile, float fontSize, const cocos2d::Size& dimensions , const cocos2d::TextHAlignment hAlignment , cocos2d::TextVAlignment vAlignment )
{
	auto ret = new (std::nothrow) TILLabelBMFontAnimated();
...
void TILLabelBMFontAnimated::setCharScale(int index, float s){

	if (index >= numLetters()) {
		cocos2d::log("TILLabelBMFontAnimated - Could not set character sprite scale, index out of bounds");
		return;
	}
...
void TILLabelBMFontAnimated::setCharOpacity(int index, float o){

	if (index >= numLetters()) {
		cocos2d::log("TILLabelBMFontAnimated - Could not set character sprite opacity, index out of bounds");
		return;
	}
...
void TILLabelBMFontAnimated::setCharRotation(int index, float r){

	if (index >= numLetters()) {
		cocos2d::log("TILLabelBMFontAnimated - Could not set character sprite rotation, index out of bounds");
		return;
	}
...
void TILLabelBMFontAnimated::setAllCharsScale(float s){
...
void TILLabelBMFontAnimated::setAllCharsOpacity(float o){
...
void TILLabelBMFontAnimated::setAllCharsRotation(float r){
...
void TILLabelBMFontAnimated::offsetAllCharsPositionBy(cocos2d::Point offset){
...
int TILLabelBMFontAnimated::numLetters(){
...
void TILLabelBMFontAnimated::runActionOnSpriteAtIndex(int index, cocos2d::FiniteTimeAction* action){

	if (index >= numLetters() || index < 0) {
		cocos2d::log("TILLabelBMFontAnimated::runActionOnSpriteAtIndex - index out of bounds");
		return;
	}
...
void TILLabelBMFontAnimated::runActionOnAllSprites(cocos2d::Action* action, bool removeOnCompletion, cocos2d::CallFunc *callFuncOnCompletion){
	...
	for (int i = 0; i < numChars; i++) {
		...
		if (i == numChars) { //if is the last character, run the call func actions
			...
			if (removeOnCompletion) {
				actionsArray.pushBack(cocos2d::CallFunc::create(CC_CALLBACK_0(TILLabelBMFontAnimated::removeFromParent, this)));
			}
...
void TILLabelBMFontAnimated::runActionOnAllSprites(cocos2d::Action* action){

	runActionOnAllSprites(action, false, nullptr);

}

void TILLabelBMFontAnimated::runActionOnAllSprites(cocos2d::Action* action, bool removeOnCompletion){

	runActionOnAllSprites(action, removeOnCompletion, nullptr);

}

void TILLabelBMFontAnimated::stopActionsOnAllSprites(){
...
void TILLabelBMFontAnimated::runActionOnAllSpritesSequentially(cocos2d::FiniteTimeAction* action, float duration, bool removeOnCompletion, cocos2d::CallFunc *callFuncOnCompletion){

	const int numChars = numLetters();

	if (numChars < 2) {
		cocos2d::log("TILLabelBMFontAnimated - runActionOnAllSpritesSequentially() requires at least 2 children to operate");
		return;
	}
...
void TILLabelBMFontAnimated::runActionOnAllSpritesSequentially(cocos2d::FiniteTimeAction* action, float duration, bool removeOnCompletion){

	runActionOnAllSpritesSequentially(action, duration, removeOnCompletion, nullptr);
}

void TILLabelBMFontAnimated::runActionOnAllSpritesSequentially(cocos2d::FiniteTimeAction* action, float duration){

	runActionOnAllSpritesSequentially(action, duration, false, nullptr);
}

void TILLabelBMFontAnimated::runActionOnAllSpritesSequentiallyReverse(cocos2d::FiniteTimeAction* action, float duration, bool removeOnCompletion, cocos2d::CallFunc *callFuncOnCompletion){

	const int numChars = numLetters();

	if (numChars < 2) {
		cocos2d::log("TILLabelBMFontAnimated - runActionOnAllSpritesSequentiallyReverse() requires at least 2 children to operate");
		return;
	}
...
void TILLabelBMFontAnimated::runActionOnAllSpritesSequentiallyReverse(cocos2d::FiniteTimeAction* action, float duration, bool removeOnCompletion){

	runActionOnAllSpritesSequentiallyReverse(action, duration, removeOnCompletion, nullptr);

}

void TILLabelBMFontAnimated::runActionOnAllSpritesSequentiallyReverse(cocos2d::FiniteTimeAction* action, float duration){
...
void TILLabelBMFontAnimated::flyPastAndRemove(){
...
void TILLabelBMFontAnimated::animateInTypewriter(float duration){
...
void TILLabelBMFontAnimated::animateInFlyInFromLeft(float duration){
...
void TILLabelBMFontAnimated::animateInFlyInFromRight(float duration){
...
void TILLabelBMFontAnimated::animateInFlyInFromTop(float duration){
...
void TILLabelBMFontAnimated::animateInFlyInFromBottom(float duration){
...
void TILLabelBMFontAnimated::animateInDropFromTop(float duration){
...
void TILLabelBMFontAnimated::animateInSwell(float duration){
...
void TILLabelBMFontAnimated::animateInRevealFromLeft(float duration){
	...
	cocos2d::CallFunc *resetZ = cocos2d::CallFunc::create(CC_CALLBACK_0(TILLabelBMFontAnimated::reorderChild, this, firstChar, firstChar->getZOrder()));
...
void TILLabelBMFontAnimated::animateSwell(float duration){
...
void TILLabelBMFontAnimated::animateJumpForever(float duration, float height){
...
void TILLabelBMFontAnimated::animateJump(float duration, float height){
...
void TILLabelBMFontAnimated::animateStretchElastic(float stretchDuration, float releaseDuration, float stretchAmount){
...
void TILLabelBMFontAnimated::animateInSpin(float duration, int spins){
...
void TILLabelBMFontAnimated::animateInVortex(float duration, int spins){

	this->animateInVortex(false, true, duration, spins);

}

void TILLabelBMFontAnimated::animateInVortex(bool removeOnCompletion, bool createGhosts, float duration, int spins){
	...
	if (createGhosts) {
		...
		for (int i = 0; i < numGhosts; i++) {
			...
			TILLabelBMFontAnimated *ghostLabel = TILLabelBMFontAnimated::createWithBMFont(getBMFontFilePath(), getString(), cocos2d::TextHAlignment::CENTER, getContentSize().width * 2, cocos2d::Vec2(0, 0));

			// TILLabelBMFontAnimated *ghostLabel = TILLabelBMFontAnimated::create(getString(), getBMFontFilePath(), getContentSize().width*2, cocos2d::kCCTextAlignmentCenter);
	...
	if (removeOnCompletion) {
		...
		cocos2d::CallFunc *remove = cocos2d::CallFunc::create(CC_CALLBACK_0(TILLabelBMFontAnimated::removeFromParent, this));
...
void TILLabelBMFontAnimated::animateRainbow(float duration){
