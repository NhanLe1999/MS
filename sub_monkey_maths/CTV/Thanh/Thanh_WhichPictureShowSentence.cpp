//
//  Thanh_WhichPictureShowSentence.cpp
//  MJQuiz
//
...
Thanh_WhichPictureShowSentence* Thanh_WhichPictureShowSentence::createQuiz()
{
	Thanh_WhichPictureShowSentence* quiz = new Thanh_WhichPictureShowSentence();
	if (quiz->_initQuiz()) {
		quiz->autorelease();
		return quiz;
	}
...
bool Thanh_WhichPictureShowSentence::init() {
	return cocos2d::ui::Layout::init();
}


#pragma mark - Quiz Life-cycle
void Thanh_WhichPictureShowSentence::initQuiz(mj::model::Game game)
{
	...
	if (game_mode == GameMode::add) {
		for (std::vector<std::pair<math::resource::Image*, int> > v : icons_group) {
			...
			group->enableToch(CC_CALLBACK_1(Thanh_WhichPictureShowSentence::onTouchedGroup, this));
...
void Thanh_WhichPictureShowSentence::onStart() {
	CCLOG("%s override", __func__);
...
void Thanh_WhichPictureShowSentence::startQuestion() {
	CCLOG("%s override", __func__);
...
void Thanh_WhichPictureShowSentence::onExplanation(bool correct) {
	CCLOG("%s override", __func__);
...
void Thanh_WhichPictureShowSentence::onComplete() {
	CCLOG("%s override", __func__);
...
void Thanh_WhichPictureShowSentence::onAnswerDone(bool correct)
{
	bool done = true;
...
void Thanh_WhichPictureShowSentence::autoTesting() {
...
void Thanh_WhichPictureShowSentence::autoTestingRun(float dt)
{

}

#pragma mark - on this Thanh_WhichPictureShowSentence
void Thanh_WhichPictureShowSentence::onTouchedGroup(cocos2d::Node* node)
{
