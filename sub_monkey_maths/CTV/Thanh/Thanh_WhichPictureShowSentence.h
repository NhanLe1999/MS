//
//  Thanh_WhichPictureShowSentence.hpp
//  MJQuiz
//
...
#ifndef Thanh_WhichPictureShowSentence_h
#define Thanh_WhichPictureShowSentence_h

#include <stdio.h>
#include "Math_Quiz.h"

class Thanh_WhichPictureShowSentence : public Math_Quiz
{
public:
	enum GameMode {
		add,
	...
	static Thanh_WhichPictureShowSentence* createQuiz();
...
private:
    ...
    Math_Group *group_be_touch = nullptr;
    Math_Group *correct_group  = nullptr;
...
#endif /* Thanh_WhichPictureShowSentence_h */
