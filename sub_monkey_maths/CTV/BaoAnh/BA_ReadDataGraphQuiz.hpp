//
//  BA_ReadDataGraphQuiz.hpp
//  MJQuiz
//
//  Created by AnhB Nguyen on 12/2/17.
//

#ifndef BA_ReadDataGraphQuiz_hpp
#define BA_ReadDataGraphQuiz_hpp
...
class BA_ReadDataGraphQuiz : public Math_Quiz{
public:
    static BA_ReadDataGraphQuiz* createQuiz();
...
private:
    ...
    struct AnswersList{
        ...
        //std::vector<Math_Answer*> answers_list_text;
        
    };
    std::vector<AnswersList> answers_list;
...
//    void onTouchedObject( cocos2d::Node *node);
   ...
   // void onAnswersDone(bool correct);
    //rieng cua game nay
    std::vector<Math_Answer*> answers;
...
#endif /* BA_ReadDataGraphQuiz_hpp */
