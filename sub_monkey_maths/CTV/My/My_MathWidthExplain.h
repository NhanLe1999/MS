#ifndef __My_MathWidthExplain_H__
#define __My_MathWidthExplain_H__

#include "Math_Quiz.h"

class My_MathWidthExplain : public Math_Quiz {
public:
	static My_MathWidthExplain* createQuiz();
...
#endif // !__My_MathWidthExplain_H__
