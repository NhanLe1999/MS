...
class MKLabelBMFontAnimated : public cocos2d::Label 
{
...
public:
	...
	static MKLabelBMFontAnimated* createWithBMFont(const std::string& bmfontFilePath, const std::string& text, const cocos2d::TextHAlignment& alignment  = TextHAlignment::LEFT, int maxLineWidth  = 0 , const cocos2d::Vec2& imageOffset  = Vec2::ZERO );
	static MKLabelBMFontAnimated* createWithTTF(const std::string& text, const std::string& fontFile, float fontSize, const cocos2d::Size& dimensions = cocos2d::Size::ZERO, cocos2d::TextHAlignment hAlignment = cocos2d::TextHAlignment::LEFT, cocos2d::TextVAlignment vAlignment  = cocos2d::TextVAlignment::TOP );
	...
	void animateInFlyInFromBottom2(float duration,float sizeH);
	...
	void animateJump(float duration, float height,std::function<void()> callback = nullptr);
	void animateJump(float duration, float height, bool isLoop);
