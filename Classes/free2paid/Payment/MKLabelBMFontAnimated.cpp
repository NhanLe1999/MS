...
MKLabelBMFontAnimated* MKLabelBMFontAnimated::createWithBMFont(const std::string& bmfontFilePath, const std::string& text, const cocos2d::TextHAlignment& alignment /* = TextHAlignment::LEFT */, int maxLineWidth /* = 0 */, const cocos2d::Vec2& imageOffset /* = Vec2::ZERO */)
{
	auto ret = new MKLabelBMFontAnimated();
...
MKLabelBMFontAnimated* MKLabelBMFontAnimated::createWithTTF(const std::string& text, const std::string& fontFile, float fontSize, const cocos2d::Size& dimensions , const cocos2d::TextHAlignment hAlignment , cocos2d::TextVAlignment vAlignment )
{
	auto ret = new (std::nothrow) MKLabelBMFontAnimated();
...
void MKLabelBMFontAnimated::setCharScale(int index, float s){

	if (index >= numLetters()) {
		cocos2d::log("MKLabelBMFontAnimated - Could not set character sprite scale, index out of bounds");
		return;
	}
...
void MKLabelBMFontAnimated::setCharOpacity(int index, float o){

	if (index >= numLetters()) {
		cocos2d::log("MKLabelBMFontAnimated - Could not set character sprite opacity, index out of bounds");
		return;
	}
...
void MKLabelBMFontAnimated::setCharRotation(int index, float r){

	if (index >= numLetters()) {
		cocos2d::log("MKLabelBMFontAnimated - Could not set character sprite rotation, index out of bounds");
		return;
	}
...
void MKLabelBMFontAnimated::setAllCharsScale(float s){
...
void MKLabelBMFontAnimated::setAllCharsOpacity(float o){
...
void MKLabelBMFontAnimated::setAllCharsRotation(float r){
...
void MKLabelBMFontAnimated::offsetAllCharsPositionBy(cocos2d::Point offset){
...
void MKLabelBMFontAnimated::stopAllCharsAction()
{
	const int numChars = numLetters();
...
int MKLabelBMFontAnimated::numLetters(){

	//int index = 0;

	//int j, n = this->getStringLength();

	//for (j = 0; j < n; ++j) {
	//	auto l = this->getLetter(j);
	//	if (l) {
	//		index++;
	//	}
	//}
...
void MKLabelBMFontAnimated::runActionOnSpriteAtIndex(int index, cocos2d::FiniteTimeAction* action){

	if (index >= numLetters() || index < 0) {
		cocos2d::log("MKLabelBMFontAnimated::runActionOnSpriteAtIndex - index out of bounds");
		return;
	}
...
void MKLabelBMFontAnimated::runActionOnAllSprites(cocos2d::Action* action, bool removeOnCompletion, cocos2d::CallFunc *callFuncOnCompletion){
	...
	for (int i = 0; i < numChars; i++) {
		...
		if (i == numChars) { //if is the last character, run the call func actions
			...
			if (removeOnCompletion) {
				actionsArray.pushBack(cocos2d::CallFunc::create(CC_CALLBACK_0(MKLabelBMFontAnimated::removeFromParent, this)));
			}
...
void MKLabelBMFontAnimated::runActionOnAllSprites(cocos2d::Action* action){

	runActionOnAllSprites(action, false, nullptr);

}

void MKLabelBMFontAnimated::runActionOnAllSprites(cocos2d::Action* action, bool removeOnCompletion){

	runActionOnAllSprites(action, removeOnCompletion, nullptr);

}

void MKLabelBMFontAnimated::stopActionsOnAllSprites(){
...
void MKLabelBMFontAnimated::runActionOnAllSpritesSequentially(cocos2d::FiniteTimeAction* action, float duration, bool removeOnCompletion, cocos2d::CallFunc *callFuncOnCompletion){

	const int numChars = numLetters();

	if (numChars < 2) {
		cocos2d::log("MKLabelBMFontAnimated - runActionOnAllSpritesSequentially() requires at least 2 children to operate");
		return;
	}
...
void MKLabelBMFontAnimated::runActionOnAllSpritesSequentially(cocos2d::FiniteTimeAction* action, float duration, bool removeOnCompletion){

	runActionOnAllSpritesSequentially(action, duration, removeOnCompletion, nullptr);
}

void MKLabelBMFontAnimated::runActionOnAllSpritesSequentially(cocos2d::FiniteTimeAction* action, float duration){

	runActionOnAllSpritesSequentially(action, duration, false, nullptr);
}

void MKLabelBMFontAnimated::runActionOnAllSpritesSequentiallyReverse(cocos2d::FiniteTimeAction* action, float duration, bool removeOnCompletion, cocos2d::CallFunc *callFuncOnCompletion){

	const int numChars = numLetters();

	if (numChars < 2) {
		cocos2d::log("MKLabelBMFontAnimated - runActionOnAllSpritesSequentiallyReverse() requires at least 2 children to operate");
		return;
	}
...
void MKLabelBMFontAnimated::runActionOnAllSpritesSequentiallyReverse(cocos2d::FiniteTimeAction* action, float duration, bool removeOnCompletion){

	runActionOnAllSpritesSequentiallyReverse(action, duration, removeOnCompletion, nullptr);

}

void MKLabelBMFontAnimated::runActionOnAllSpritesSequentiallyReverse(cocos2d::FiniteTimeAction* action, float duration){
...
void MKLabelBMFontAnimated::flyPastAndRemove(){
...
void MKLabelBMFontAnimated::animateInTypewriter(float duration){
...
void MKLabelBMFontAnimated::animateInFlyInFromLeft(float duration){
...
void MKLabelBMFontAnimated::animateInFlyInFromRight(float duration){
...
void MKLabelBMFontAnimated::animateInFlyInFromTop(float duration){
...
void MKLabelBMFontAnimated::animateInFlyInFromBottom(float duration){
...
void MKLabelBMFontAnimated::animateInFlyInFromBottom2(float duration, float sizeH)
{
	float rescaleFactor = 1 / getScale(); //if the label has been scaled down, all the action coordinates will be too small, rescale factor scales them up
	float offsetY = sizeH * rescaleFactor;
	offsetAllCharsPositionBy(cocos2d::Point(0, -offsetY));
	
	auto sacale = ScaleTo::create(0.0f,0.0f);

	cocos2d::FadeOut* fadeOut = cocos2d::FadeOut::create(0.0f);
	cocos2d::MoveBy* flyIn					= cocos2d::MoveBy::create(1, cocos2d::Point(0, offsetY));
	cocos2d::EaseExponentialOut* flyInEase	= cocos2d::EaseExponentialOut::create(flyIn);
	cocos2d::Spawn* spawn = cocos2d::Spawn::create(flyInEase, FadeIn::create(1.0f),ScaleTo::create(1.0f,1.0f),nullptr);
	auto seq = Sequence::create(sacale,fadeOut, spawn,nullptr);

	runActionOnAllSpritesSequentially(seq, duration);
}

void MKLabelBMFontAnimated::animateInDropFromTop(float duration){
...
void MKLabelBMFontAnimated::animateInSwell(float duration){
...
void MKLabelBMFontAnimated::animateInRevealFromLeft(float duration){
	...
	cocos2d::CallFunc *resetZ = cocos2d::CallFunc::create(CC_CALLBACK_0(MKLabelBMFontAnimated::reorderChild, this, firstChar, firstChar->getZOrder()));
...
void MKLabelBMFontAnimated::animateSwell(float duration){
...
void MKLabelBMFontAnimated::animateJumpForever(float duration, float height){
	...
	for (int i = 0; i < numLetters(); i++) {
		...
		cocos2d::DelayTime *delay = cocos2d::DelayTime::create((duration / (numChars - 1)) *i);
		//cocos2d::log("i=%d,xxxx=%f", i, (duration / (numChars - 1)) *i);
		cocos2d::JumpTo *jump = cocos2d::JumpTo::create(0.5, charSprite->getPosition(), height, 1);
		cocos2d::Sequence *delayThenJump = cocos2d::Sequence::create(delay, jump, cocos2d::DelayTime::create((duration + 0.0) - ((duration + 0.0) / (numChars - 1)) *i), NULL);
		charSprite->runAction(RepeatForever::create(delayThenJump));

	}
}

void MKLabelBMFontAnimated::animateJump(float duration, float height, std::function<void()> callback){

	const int numChars = numLetters();

	if (numChars <= 0 && callback) {
			callback();
	}
	...
	for (int i = 0; i < numLetters(); i++) {
		...
		if (i == numChars - 1) {
			cocos2d::Sequence* delayThenJump = cocos2d::Sequence::create(delay, jump, CallFunc::create([callback]() {
			...
			cocos2d::Sequence* delayThenJump = cocos2d::Sequence::createWithTwoActions(delay, jump);
			charSprite->runAction(delayThenJump);
		}
	}
}

void MKLabelBMFontAnimated::animateJump(float duration, float height, bool isLoop)
{
	stopAllCharsAction();

	if (isLoop) {

		animateJump(duration, height, [=]() {
		
			animateJump(duration, height, true);
		});
	} else {
		animateJump(duration, height);
	}
...
void MKLabelBMFontAnimated::animateStretchElastic(float stretchDuration, float releaseDuration, float stretchAmount){
...
void MKLabelBMFontAnimated::animateInSpin(float duration, int spins){
...
void MKLabelBMFontAnimated::animateInVortex(float duration, int spins){

	this->animateInVortex(false, true, duration, spins);

}

void MKLabelBMFontAnimated::animateInVortex(bool removeOnCompletion, bool createGhosts, float duration, int spins){
	...
	if (createGhosts) {
		...
		for (int i = 0; i < numGhosts; i++) {
			...
			MKLabelBMFontAnimated *ghostLabel = MKLabelBMFontAnimated::createWithBMFont(getBMFontFilePath(), getString(), cocos2d::TextHAlignment::CENTER, getContentSize().width * 2, cocos2d::Vec2(0, 0));

			// MKLabelBMFontAnimated *ghostLabel = MKLabelBMFontAnimated::create(getString(), getBMFontFilePath(), getContentSize().width*2, cocos2d::kCCTextAlignmentCenter);
	...
	if (removeOnCompletion) {
		...
		cocos2d::CallFunc *remove = cocos2d::CallFunc::create(CC_CALLBACK_0(MKLabelBMFontAnimated::removeFromParent, this));
...
void MKLabelBMFontAnimated::animateRainbow(float duration){
