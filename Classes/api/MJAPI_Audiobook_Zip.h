//
//  MJAPI_Audiobook_Zip.hpp
//  MJStory
//
//  Created by To Ngoc Linh on 4/19/18.
//

#ifndef MJAPI_Audiobook_Zip_hpp
#define MJAPI_Audiobook_Zip_hpp
...
namespace mj {
    namespace api {
        class AudiobookZip : public ap::api::RequestDelegate, public cocos2d::Ref {
        public:
