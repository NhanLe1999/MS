...
#ifndef MJAPI_LessonList_Zip_hpp
#define MJAPI_LessonList_Zip_hpp
...
namespace mj {
    namespace api {
        class LessonListZip : public ap::api::RequestDelegate, public cocos2d::Ref {
        public:
...
#endif /* MJAPI_LessonList_Zip_hpp */
