...
#ifndef MJAPI_Categories_Zip_hpp
#define MJAPI_Categories_Zip_hpp
...
namespace mj {
    namespace api {
        class CategoriesZip : public ap::api::RequestDelegate, public cocos2d::Ref {
        public:
...
#endif /* MJAPI_Categories_Zip_hpp */
