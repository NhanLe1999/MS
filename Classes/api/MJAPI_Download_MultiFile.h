...
#ifndef MJAPI_Download_MultiFile_hpp
#define MJAPI_Download_MultiFile_hpp
...
namespace mj {
    namespace api {
        class MJAPI_Download_MultiFile :public ms::utils::Downloader{
        public:
        ...
        private:
            ...
            MJAPI_Download_MultiFile(std::string keyResPath);
            MJAPI_Download_MultiFile(ThumbDownloadInfo* thumbDownloadInfo);
            MJAPI_Download_MultiFile(std::vector<ThumbDownloadInfo*> thumbDownloadInfos);
...
#endif /* MJAPI_Download_MultiFile_Zip */