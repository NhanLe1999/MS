...
#ifndef GingerBreadMan_VM_Board_HPP
#define GingerBreadMan_VM_Board_HPP
...
class GingerBreadMan_VM_BoardDelegate {
public:
    virtual void onBoardStartHide() {};
};

class GingerBreadMan_VM_Board : public cocos2d::ui::Layout {
public:
    CREATE_FUNC(GingerBreadMan_VM_Board);
    static GingerBreadMan_VM_Board * createItem(mj::PHONIC_BOARD_INFO item_info);
    void setDelegate(GingerBreadMan_VM_BoardDelegate *delegate);
    void showBoard();
private:
    ...
    GingerBreadMan_VM_BoardDelegate *_delegate;
...
CREATE_READER(GingerBreadMan_VM_Board);
