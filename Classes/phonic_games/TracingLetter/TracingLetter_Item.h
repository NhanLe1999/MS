#ifndef __MJ_TRACING_LETTER_ITEM_H__
#define __MJ_TRACING_LETTER_ITEM_H__
...
class TracingLetter_Item : public cocos2d::ui::Layout {
public:
	static TracingLetter_Item * createItem(int id,math::common::TouchPermission touch,math::resource::Image * image, std::string gaf_file_path = "", bool color = false);
...
#endif // !__MJ_TRACING_LETTER_ITEM_H__
