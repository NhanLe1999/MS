...
SpaceShip_VM_Blur * SpaceShip_VM_Blur::createBlur(int blur_type) {
    SpaceShip_VM_Blur * obj = new SpaceShip_VM_Blur();
    if(obj->init())
    {
        obj->autorelease();
...
void SpaceShip_VM_Blur::didLoadFromCSB(int blur_type){
...
void SpaceShip_VM_Blur::onEnter(){
    cocos2d::ui::Layout::onEnter();
}

void SpaceShip_VM_Blur::addBlurPlanet(){
    auto img_path = std::string("games/SpaceShip_VM/SpaceShip_VM_planet.png");
...
void SpaceShip_VM_Blur::addBlurStar(){
    auto img_path = std::string("games/SpaceShip_VM/SpaceShip_VM_blur_star.png");
    img_blur1 = cocos2d::ui::ImageView::create(img_path);
    img_blur1->setAnchorPoint(Vec2::ANCHOR_BOTTOM_LEFT);
    this->addChild(img_blur1);
...
void SpaceShip_VM_Blur::addBlurBackground(){
    auto img_path = std::string("games/SpaceShip_VM/SpaceShip_VM_bg.png");
...
void SpaceShip_VM_Blur::runBlur(){
...
void SpaceShip_VM_Blur::runBlur(cocos2d::ui::ImageView *blur_img, int width, float duration){
...
void SpaceShip_VM_Blur::runBlurFast(const std::function<void()> func){
...
void SpaceShip_VM_Blur::resetBlur(){
    if (blur_type == BG_TYPE) {
...
void SpaceShip_VM_Blur::setDelegate(SpaceShip_VM_BlurDelegate *delegate){
