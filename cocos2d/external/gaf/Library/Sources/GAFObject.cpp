...
//
//        auto sequences_info = getSequences();
//
//        if (m_asset->getGAFFileName().find("662") != std::string::npos && reference == 5) {
//            auto mask_sprite = Sprite::createWithSpriteFrame(spriteFrame);
//            auto mask_size = mask_sprite->getContentSize();
//            mask_sprite->setAnchorPoint(Point::ANCHOR_MIDDLE);
//            mask_sprite->setFlippedY(true);
//
...
//
//            auto sprite = Sprite::create("face.jpg");
//            sprite->setAnchorPoint(Point::ANCHOR_MIDDLE);
//            sprite->setFlippedY(true);
//            mask->addChild(sprite);
//
//            auto pos = sprite->getPosition();
//            pos = mask->convertToWorldSpace(pos);
//
//            auto layout = ui::Layout::create();
//            layout->setContentSize(mask_size);
//            layout->addChild(mask);
//
//            auto final_sprite = captureNode(layout, 1);
//            spriteFrame = final_sprite->getSpriteFrame();
//        }
//        
        if (spriteFrame)
        {
